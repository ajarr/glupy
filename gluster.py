...
class dirent_list_head (Structure):
        _fields_ = [
                ("next", POINTER(gf_dirent_t)),
                ("prev", POINTER(gf_dirent_t))
        ]

class u_dirent_list_head (Union):
        _anonymous_ = ("dirent_list",)
        _fields_ = [
                ("list", list_head),
                ("dirent_list", dirent_list_head)
        ]

gf_dirent_t._anonymous_ = ("u_dirent_list",)
gf_dirent_t._fields_ = [
                ("u_dirent_list", u_dirent_list_head),
                ("d_ino", c_uint64),
                ("d_off", c_uint64),
                ("d_len", c_uint32),
                ("d_type", c_uint32),
